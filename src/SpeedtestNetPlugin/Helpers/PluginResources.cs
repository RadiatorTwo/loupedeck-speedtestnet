namespace Loupedeck.SpeedtestNetPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.SpeedtestNetPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.SpeedtestNetPlugin.Resources.Resource.txt`.
